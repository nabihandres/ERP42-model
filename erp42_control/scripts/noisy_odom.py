...
#https://www.youtube.com/watch?v=QZ5q59H2qaI (minute 25)
...
class NoisyOdom():
    ...
    def add_noise(self):
        ...
        rand_float = random.uniform(-0.5,0.5)  #add noisy only in to y axes
...
#this is in other to create noisy in the odometry called noisy odom the new topic